...
def main(cfg):
    ...
    tasks, class_names = make_tinyimagenet_tasks(cfg['num_tasks'], cfg['batch_size'], augment=True)

    norm = transforms.Normalize((0.485, 0.456, 0.406), (0.229, 0.224, 0.225))
    test_transform = transforms.Compose([transforms.ToTensor(), norm])
    train_full = datasets.ImageFolder('data/tiny-imagenet-200/train', transform=None)
    test_full = datasets.ImageFolder('data/tiny-imagenet-200/val/images_formatted', transform=test_transform)
