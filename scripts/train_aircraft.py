...
def main(cfg):
    ...
    test_full = FGVCAircraft(root="data", split='test', download=True, transform=test_transform)
    train_full = FGVCAircraft(root="data", split='trainval', download=True, transform=test_transform)

    test_labels = test_full._labels
    train_labels = train_full._labels
